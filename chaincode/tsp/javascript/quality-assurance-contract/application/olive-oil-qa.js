...
const org1UserId = 'appUserOliveOilQAFullProduct';
...
async function main() {
    ...
    try {
        ...
        const productTypeToVerify = 'olive-oil';
        const productIdToVerify = 'olive-oil-001';
        ...
        try {
            const resultBuffer = await qualityAssuranceContract.submitTransaction(
                ...
                productTypeToVerify,
                productIdToVerify,
                'standardoliveoil'  // name for the chaincode for when it was deployed
            );
